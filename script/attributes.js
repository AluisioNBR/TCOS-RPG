var Attributes = {
    ...
    dex: 3,
    int: 3,
    updateStr: function (value) {
        Attributes.str = value;
    },
    updateVit: function (value) {
        Attributes.vit = value;
    },
    updateSpd: function (value) {
        Attributes.spd = value;
    },
    updateDex: function (value) {
    ...
    priceCalc: function () {
        var attributes = $('.progress-bar'), indicator = $('.progress-bar-value');
        var current = [
            Attributes.str,
            Attributes.vit,
            Attributes.spd,
        ...
        for (var x = 0; x < attributes.length; x++) {
            ...
            if (Number(attributes[x].value) > current[x]) {
                ...
                var inc = Number(indicator[x].value) * 25;
